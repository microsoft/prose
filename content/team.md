...
{{% about-row name="Sumit Gulwani" img="Sumit-Gulwani.jpg"
...
{{% about-row name="Vu Le" img="Vu-Le.jpg" link="http://vuminhle.com/" %}}
...
{{% about-row name="Daniel Perelman" img="Daniel-Perelman.jpg" link="https://homes.cs.washington.edu/~perelman/" %}}
...
{{% about-row name="Alex Polozov" img="Alex-Polozov.jpg" link="http://alexpolozov.com" %}}
...
{{% about-row name="Mohammad Raza" img="Mohammad-Raza.jpg"
              link="http://research.microsoft.com/en-us/people/moraza" %}}
...
{{% about-row name="Danny Simmons" img="Danny-Simmons.jpg"
              link="http://blogs.msdn.com/dsimmons" %}}
...
{{% about-row name="Adam Smith" img="Adam-Smith.jpg" link="https://adamsmith.as/" %}}

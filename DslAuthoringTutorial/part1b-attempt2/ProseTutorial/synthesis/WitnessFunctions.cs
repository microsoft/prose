...
namespace ProseTutorial
{
    public class WitnessFunctions : DomainLearningLogic
    {
        ...
        /// <summary>
        ///     This is a conditional witness function. In the presence of multiple occurrences of the output string in the input
        ///     string,
        ///     We can only write a witness function for an end position for each start position. Thus, our witness function for
        ///     the end position
        ///     is conditional on the start position: in addition to an outer spec, it takes an additional input – a spec on its
        ///     prerequisite start position parameter.
        /// </summary>

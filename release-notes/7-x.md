...
## [Release 7.32.0](https://www.nuget.org/packages/Microsoft.ProgramSynthesis/7.32.0) - 2021/06/28
- Transformation.Text
    - Fixed an issue where Transformation.Text translation for PowerFx was not properly handling native DateTime or Number values.
- Extraction.Pdf 
    - Fixed bug when processing text on edge of page.

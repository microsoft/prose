...
- Extraction.Pdf
  - Fixed edge cases in bidirectional text support to get correct logical order and add control codes where necessary to get correct rendering order.
  - Fixed exception in certain PDFs with border lines.
...
- Extraction.Pdf
  - Added right-to-left and bidirectional text support.
  - Improved table algorithm to accidentally combine nearby text into a single cell much less often.
- Read.FlatFile 

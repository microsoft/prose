...
.NET Lab
- Extraction.Pdf: Rebuilt pdf2text.dll to fix BinSkim warning about not having Spectre mitigations.

.NET
- Read.FlatFile: dded initial support for more complicated text files using Extraction.Text (disabled by default).
